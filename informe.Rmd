...
```{r,echo=TRUE,eval=TRUE}
#r,echo=FALSE sirve para motrar o no las lineas de codigo
#eval si se corre o no el programa
...
Para $\beta_2$
Como $t=`r summary(reg)[[4]][2,3]`$ es `r tex<-"menor"; if(summary(reg)[[4]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"mayor"; tex` que $t_{`r (nrow(data)-2)`}(\frac{\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
`r tex<-"no rechazo"; if(summary(reg)[[4]][2,3]>qt(0.975,(nrow(data)-2))) tex<-"rechazo"; tex`
$H_0: \beta_2=0$.

Para $\beta_1$
Como $t=`r summary(reg)[[4]][1,3]`$ es `r tex<-"menor"; if(summary(reg)[[4]][1,3]>qt(0.975,(nrow(data)-2))) tex<-"mayor"; tex` que $t_{`r (nrow(data)-2)`}(\frac{\alpha}{2})= `r qt(0.975,(nrow(data)-2))`$
`r tex<-"no rechazo"; if(summary(reg)[[4]][1,3]>qt(0.975,(nrow(data)-2))) tex<-"rechazo"; tex`
$H_0: \beta_1=0$.
